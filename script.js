const pages = [
  ...
  `After that, we went inside the convenience store, I was still shy towards her so I just talked to Ahron while we were inside, then Ahron asked me "Why aren't you talking to her bro?"\nI didn't wanna answer, I can't just tell the reason why, Ciara was literally behind me. While I was just laughing it off, Ciara hugged me from behind, I felt butterflies, I was really blushing that time, no lies.`,
  ...
  `I went home as well since it was getting dark. While I was riding the bus, I can't help but smile and think about the things that happen that day.`,
  ...
  `Maybe she's the right person but it's just the wrong time.`,
